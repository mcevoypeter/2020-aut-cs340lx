...
// we can't call panic withut disabling mmu: fix in the core system.
#define mem_panic(args...) do { mmu_disable(); panic(args); } while(0)

// need to work through this: sorry guys.
// #undef panic
// #undef assert
